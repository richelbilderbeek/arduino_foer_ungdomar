...
cp ../kapitel/01_anvaendning_av_den_inbyggda_lysdioden/*.* $build_folder; mv $build_folder/README.md $build_folder/README_02.md
cp ../kapitel/02_anvaendning_av_en_multimeter/*.*          $build_folder; mv $build_folder/README.md $build_folder/README_03.md
cp ../kapitel/03_anslutning_av_en_lysdiod/*.*              $build_folder; mv $build_folder/README.md $build_folder/README_04.md
