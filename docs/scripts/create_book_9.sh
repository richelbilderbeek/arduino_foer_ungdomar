...
cp ../kapitel/25_maetning_av_en_dc_motor/*.*    $build_folder; mv $build_folder/README.md $build_folder/README_01.md
cp ../kapitel/26_anslutning_av_en_dc_motor/*.*  $build_folder; mv $build_folder/README.md $build_folder/README_02.md
cp ../kapitel/27_anvaendning_av_en_dc_motor/*.* $build_folder; mv $build_folder/README.md $build_folder/README_03.md
