...
![23.1. Koppla spänning till kretskortet](23_ansluting_av_en_relae_power.png)
...
![Koppla `GND` på Arduino med `IN1` på reläkortet](23_ansluting_av_en_relae_connect_1_pin.png)
...
![23.5. En schematisk H-brygga](23_ansluting_av_en_relae_h_bridge_schematic_cc_by.png)
