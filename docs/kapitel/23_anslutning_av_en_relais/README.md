...
Connect an LED to the relais:

![23](23_ansluting_av_en_relais_one_led.png)

Does the LED light up. Why?

Connect the `GND` of the Arduino with the `IN1` of the relay board.
Does the LED light up? Why`

![23](23_ansluting_av_en_relais_connect_1_pin.png)

Yes, the LED should light up.
