...
cp ../kapitel/28_maetning_av_en_avstaandssensor/*.*    $build_folder; mv $build_folder/README.md $build_folder/README_01.md
cp ../kapitel/29_anslutning_av_en_avstaandssensor/*.*  $build_folder; mv $build_folder/README.md $build_folder/README_02.md
cp ../kapitel/30_anvaendning_av_en_avstaandssensor/*.* $build_folder; mv $build_folder/README.md $build_folder/README_03.md
