...
cp ../kapitel/13_maetning_av_en_joystick/*.*    $build_folder; mv $build_folder/README.md $build_folder/README_01.md
cp ../kapitel/14_anslutning_av_en_joystick/*.*  $build_folder; mv $build_folder/README.md $build_folder/README_02.md
cp ../kapitel/15_anvaendning_av_en_joystick/*.* $build_folder; mv $build_folder/README.md $build_folder/README_03.md
